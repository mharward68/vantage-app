...
- `app.js` — all application logic, one file, ~13,100 lines (`index.html` ~3,200, `style.css` ~3,100). The number is here so a session can size a change; keep it approximate but true.
