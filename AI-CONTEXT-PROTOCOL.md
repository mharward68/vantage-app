...
**Step 4: Generate the New Context File**
...
2. **Current Goals:** Insert the goals exactly as explained by the user in Step 2.

**Step 7: Ongoing Maintenance Directive**
Acknowledge to the user that the rollover is complete. Moving forward, as development progresses, actively append new development notes, decisions, and completed tasks to the bottom of the active `AI-CONTEXT.md` file.
